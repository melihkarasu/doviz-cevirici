...
Frankfurter & ECB resmi kurları ile 30+ para birimi, anlık çapraz kur çevirisi, Chart.js trend grafikleri ve getiri analizi.
...
- **API Source:** TCMB / Exchange Rates API
